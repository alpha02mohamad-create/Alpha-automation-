...
from stages.gemini_client import generate_json

MAX_VIDEO_SECONDS = 59
MAX_OUTPUT_TOKENS = 4096  # سكربت كامل بكل الحقول لكل segment + هامش كافٍ للتفكير الداخلي
...
def generate_script(idea: dict, recent_hook_structures: list[str] | None = None) -> dict:
    ...
    data = generate_json(
        ...
        thinking_level="low",  # مهمة إبداعية أعقد من توليد الفكرة، محتاجة تفكير أكتر
    )
